...
class ResultWidgetPanel(object):
    ...
    def setupUi(self, Form):
        ...
        self.tableWidget.horizontalHeader().sectionPressed.connect(lambda: self.changeAllItemState())
    ...
    def downloadAction(self):
        ...
        for iterator in self.dataOfDocuments:
            sciHub_controller = scrihub.main(iterator.__getitem__(2), './Downloads')
