...
class Ui_MainWindow:
    ...
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon('./GUI/english.png')

        self.comboBox.addItem(icon1, '')
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap('./GUI/spanish.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBox.addItem(icon2, "")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("./GUI/euskera.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
